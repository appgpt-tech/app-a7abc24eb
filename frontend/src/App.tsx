...
import { SecureList, SecureCreate, SecureEdit } from './resources/Secure';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a7abc24eb">
      <Admin
        authProvider={
      ...
      >
        <Resource
          name="Secure"
          options={{ label: 'Secure' }}
          list={SecureList}
          create={SecureCreate}
          edit={SecureEdit}
          recordRepresentation="lastSecurityUpdate"
          icon={SecureIcon}
        />
